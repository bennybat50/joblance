...
export default function Blog(){
    ...
    {/* <!-- LOADING AREA  END ====== -->    */}
            ...
            <div class="page-content">
                ...
                {/* <!-- INNER PAGE BANNER --> */}
                <div class="wt-bnr-inr overlay-wraper bg-center" style={{ backgroundImage: `url(${banner_1})` }}
>
                                ...
                                <div class="masonry-wrap row d-flex">
                                    {
                                        ...
                                        <Link to={`/blog/${data._id}`} class="masonry-item col-lg-6 col-md-12">

                                            <div class="blog-post twm-blog-post-1-outer">
                                                <div class="wt-post-media " style={{height:"250px"}}>
                                                    <img src={data.image} alt="" style={{height:"100%", objectFit: "cover"}}/>
                                                </div>                                    
            ...
            {/* <!-- FOOTER START --> */}
            <footer class="footer-dark" style={{backgroundImage: 'url(images/f-bg.jpg)', backgroundPosition: 'center'}}>
