...
export default function UserEditAticle() {
    ...
    useEffect(()=>{
        const getArticle = async () => {
            let api_url = BASEURL + "/articles/" +  articleID
            console.log(api_url)
            ...
            try {
                ...
                // setInterest(res.data.data.jobCategory_id.name)
                setPublicData(res.data.data.isPublic)
    ...
    const handleArticle = async (event) => {
        ...
        let api_url = BASEURL + "/article/update/" + articleID;
        await axios.put(api_url, articleData)
        .then((res)=>{
            console.log(res.data)
        })
                                    ...
                                    <form onSubmit={handleArticle}>
                                        ...
                                        <div class="panel panel-default">
                                            <div class="panel-heading wt-panel-heading p-a20">
                                                <h4 class="panel-tittle m-a0">Edit Article</h4>
                                            </div>
