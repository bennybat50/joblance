...
export default function CreateAticle() {
  ...
  const handleArticle = async (event) => {
    ...
    let articleData = {
      ...
      image: image,
      content: content,
      is_public: publicData,
      interest_id: interestID,
      user_id: userDetails._id,
    };
    console.log(articleData);
    const api_url = BASEURL + "/create-article";
                        ...
                        <div class="row">
                          ...
                          <div class="col-xl-3 col-lg-3 col-md-12">
                            <div class="form-group">
                              ...
                              <div>
                                {err === true && image === "" ? (
                                  <p style={{ color: "red" }}>enter image</p>
                                ) : null}
                              </div>
                            </div>
                          </div>
                            ...
                            <div class="form-group city-outer-bx has-feedback">
                              ...
                              <div class="ls-inputicon-box">
                                <select
                                  ...
                                  data-bv-field="size"
                                  onChange={(e) =>
                                    setPublicData(e.target.value === "true")
                                  }
                              ...
                              <div>
                                {err === true && publicData === "" ? (
                                  <p style={{ color: "red" }}>enter public</p>
                                ) : null}
                              </div>
                            </div>
                          </div>
                          ...
                          <div class="col-xl-4 col-lg-4 col-md-12">
                            <div class="form-group city-outer-bx has-feedback">
                              ...
                              <div>
                                {err === true && interestID === "" ? (
                                  <p style={{ color: "red" }}>enter interest</p>
                                ) : null}
                              </div>
                            </div>
                          </div>
                          ...
                          <div class="col-md-12">
                            ...
                            <div>
                              {err === true && content === "" ? (
                                <p style={{ color: "red" }}>enter content</p>
                              ) : null}
                            </div>
                          </div>
