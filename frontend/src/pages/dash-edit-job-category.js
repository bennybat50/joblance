...
export default function DashEditJobCategory() {
  ...
  useEffect(() => {
    const getJobCategory = async () => {
        let api_url = BASEURL + "/job-category/" + jobCategoryId;
  ...
  const postJobCategory = (e) => {
    ...
    let apiURL = BASEURL + "/job-category/update/" + jobCategoryId

    axios.put(apiURL, jobData)
    .then((res)=> {
        console.log(res.data)
