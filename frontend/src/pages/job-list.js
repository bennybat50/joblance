   ...
   <div className="row">
       ...
       <div className="col-lg-8 col-md-12">
           ...
           <div className="twm-employer-list-wrap">
               <ul>
                    <li>
                        <Link to="/job-detail" className="link-tag twm-employer-list-style1 mb-5">
                            ...
                            <div className="twm-mid-content">
                                ...
                                <a href="employer-detail" className="twm-job-websites site-text-primary">Accountancy</a>
                            </div>
                    ...
                    <li>
                        <Link to="/job-detail" className="link-tag twm-employer-list-style1 mb-5 ">
                            ...
                            <div className="twm-mid-content">
                                <a href="employer-detail" className="twm-job-title link-tag">
                                    <h5>Artistre Studio PVT Ltd</h5>
                                </a>
                                <p className="twm-job-address">1363-1385 Sunset Blvd Los Angeles, CA 90026, USA</p>
                                <a href="employer-detail" className="twm-job-websites site-text-primary">IT Contractor</a>
                            </div>
                            <div className="twm-right-content">
                    ...
                    <li>
                        <Link to="/job-detail" className=" link-tag twm-employer-list-style1 mb-5">
                            ...
                            <div className="twm-mid-content">
                                ...
                                <p className="twm-job-address">1363-1385 Sunset Blvd Los Angeles, CA 90026, USA</p>
                                <a href="employer-detail" className="twm-job-websites site-text-primary">Banking</a>
                            </div>
                            <div className="twm-right-content">
                    ...
                    <li>
                        <Link to="/job-detail" className="link-tag twm-employer-list-style1 mb-5">
                            ...
                            <div className="twm-mid-content">
                                ...
                                <p className="twm-job-address">1363-1385 Sunset Blvd Los Angeles, CA 90026, USA</p>
                                <a href="employer-detail" className="twm-job-websites site-text-primary">Digital & Creative</a>
                            </div>
                            <div className="twm-right-content">
                    ...
                    <li>
                        <Link to="/job-detail" className="link-tag twm-employer-list-style1 mb-5">
                            ...
                            <div className="twm-mid-content">
                                ...
                                <p className="twm-job-address">1363-1385 Sunset Blvd Los Angeles, CA 90026, USA</p>
                                <a href="employer-detail" className="twm-job-websites site-text-primary">Sales & Marketing</a>
                            </div>
                            <div className="twm-right-content">
                    ...
                    <li>
                       <Link to="/job-detail" className="link-tag twm-employer-list-style1 mb-5">
                           ...
                           <div className="twm-mid-content">
                               ...
                               <p className="twm-job-address">1363-1385 Sunset Blvd Los Angeles, CA 90026, USA</p>
                               <a href="employer-detail" className="twm-job-websites site-text-primary">Leisure & Tourismm</a>
                           </div>
                           <div className="twm-right-content">
                               <div className="twm-jobs-vacancies"><span>38</span>Vacancies</div>
                           </div>
                    ...
                    <li>
                       <Link to="/job-detail" className="link-tag twm-employer-list-style1 mb-5">
                           ...
                           <div className="twm-mid-content">
                               ...
                               <p className="twm-job-address">1363-1385 Sunset Blvd Los Angeles, CA 90026, USA</p>
                               <a href="employer-detail" className="twm-job-websites site-text-primary">Consultancy</a>
                           </div>
                           <div className="twm-right-content">
                    ...
                    <li>
                       <Link to="/job-detail" className="link-tag twm-employer-list-style1 mb-5">
                           ...
                           <div className="twm-mid-content">
                               ...
                               <p className="twm-job-address">1363-1385 Sunset Blvd Los Angeles, CA 90026, USA</p>
                               <a href="employer-detail" className="twm-job-websites site-text-primary">Technologies</a>
                           </div>
                           <div className="twm-right-content">
